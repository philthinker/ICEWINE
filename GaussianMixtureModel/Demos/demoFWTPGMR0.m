%demoFWTPGMR0 A demo for the class @FWTPGMMZero
%   It is quite similar to demoTPGMR1.m
%
%   Haopeng Hu
%   2020.10.07
%   All rights reserved
...
for i = 1:M
    ...
    [reprodTPGMM(i).data, reprodTPGMM(i).Sigma, alpha] = tpgmm.GMR(query,reprodTPGMM(i).qFrames);
end
