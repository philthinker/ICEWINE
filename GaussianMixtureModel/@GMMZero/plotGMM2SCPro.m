function [h] = plotGMM2SCPro(obj, Mu, Sigma, color, valAlpha)
%plotGMM2SCPro This function displays the parameters of a Gaussian Mixture Model (GMM).
%   Mu:           K x D, the K means of dimension D
%   Sigma:        D x D x K, the K covariances of dimension D
